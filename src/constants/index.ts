...
import {
  CategoriesType,
  LargeSidebarIconsType,
  SmallSidebarIconsType,
  VideoType,
} from './types';
...
export const smallSidebarIcons: Array<SmallSidebarIconsType> = [
  {
    id: 1,
    Icon: Home,
    title: 'Home',
...
export const largeSidebarIcons: Array<LargeSidebarIconsType> = [
  {
    id: 1,
    links: [
      {
